...
It provided convince methods for reading the current time and converting the
...
Authenticator.  This implementation of \texttt{base32\_decode} was chosen to
insure that the secret key would be decoded in the exact way intended.
...
listening for a button press and generating a token.
